...
### Variable definition ###
  ...
  variable "stackName" {
    description = "Cloud Stack Template Name"
  }  

  variable "stackTemplateVersion" {
    description = "Cloud Stack Template Version"
  }  

  variable "wait_until_complete" {
    description = "Cloud Stack Template Wait until complete option"
  }  
