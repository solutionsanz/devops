...
ALTER TABLE admin.sales
  ...
  FOREIGN KEY (promo_id) REFERENCES admin.promotions (promo_id)
  RELY DISABLE NOVALIDATE;
 
ALTER TABLE admin.costs
...
ALTER TABLE admin.sales
  ...
  FOREIGN KEY (cust_id) REFERENCES admin.customers (cust_id)
  RELY DISABLE NOVALIDATE;
...
ALTER TABLE admin.sales
  ...
  FOREIGN KEY (prod_id) REFERENCES admin.products (prod_id)
  RELY DISABLE NOVALIDATE;
...
ALTER TABLE admin.sales
  ...
  FOREIGN KEY (time_id) REFERENCES admin.times (time_id)
  RELY DISABLE NOVALIDATE;
...
ALTER TABLE admin.sales
  ...
  FOREIGN KEY (channel_id) REFERENCES admin.channels (channel_id)
  RELY DISABLE NOVALIDATE;
...
ALTER TABLE admin.customers
  ...
  FOREIGN KEY (country_id) REFERENCES admin.countries (country_id)
  RELY DISABLE NOVALIDATE;
 
ALTER TABLE admin.supplementary_demographics
